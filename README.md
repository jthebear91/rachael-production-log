...
- Wholesale Square invoices and house-account receipts → Todoist **Takeout** pull task (p1, top of the board) and a qty/name pick-list PDF with a WHOLESALE banner. The Trey laptop (`Trey-s-A25`, user `rachaelsseafood`) drops that PDF in `~/Documents/Wholesale Ordering/pull-sheets/`. Optional CUPS queue: `Brother_HL_L3280CDW_series`. See [docs/wholesale-pull.md](docs/wholesale-pull.md)
