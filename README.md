...
| `BRIDGE_API_KEY` | Shared secret for `/api/square/*` (GET reads and `POST /api/square/invoices/create`). Routes fail closed (503) if unset. Catalog, inventory, and health stay on this key only. |
